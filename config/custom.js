 ...
 */
 ...
 module.exports.custom = {
   ...
   **************************************************************************/
   ...
   fromEmailAddress: 'YOUR_EMAIL_HERE@gmail.com',
   fromName: 'The Apsalus Team',

   // Email address for receiving support messages & other correspondences.
   // > If you're using the default privacy policy, this will be referenced
   // > as the contact email of your "data protection officer" for the purpose
   // > of compliance with regulations such as GDPR.
   internalEmailAddress: 'YOUR_EMAIL_HERE@gmail.com',
   ...
   ***************************************************************************/
   // …
   gridfs_url: process.env.sails_gridfs__default__url,

   usps_user_id: process.env.USPS_USER_ID,
   usps_pass: process.env.USPS_PASS,
   usps_origin_zip: process.env.USPS_ORIGIN_ZIP,
 };
