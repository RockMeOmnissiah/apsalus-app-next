...
export default function Overview({ me, categories }) {
  ...
  const onSubmit = async (data) => {
    ...
    await fetch('/api/csrfToken', {
      ...
      await fetch('/api/product/category/delete', {
        method: 'DELETE',
        credentials: 'include',
        headers: {
          'Content-Type': 'application/json',
  ...
  return (
    <div className="flex flex-col items-center justify-center py-2">
      ...
      <main className="flex flex-col items-center justify-center w-full flex-1 px-10 pt-4 pb-16 mb-16 bg-base-200 text-center">
        ...
        {me && me.isSuperAdmin &&
          <a href="/products/categories/create" className="btn btn-primary btn-outline btn-sm float-right">
            Create Category
            ...
            <DataTable
              ...
              data={categories.map(function(cat, idx){
                ...
                return {
                  ...
                  title_display: <>
                    <a href={"/products/view/category/" + cat.slug }
                    ...
                    {me && me.isSuperAdmin && <>
                      ...
                      <a href={"/products/categories/update?id=" + cat.id }
